...
List<AppliedFix> _fixSupportsRtl(String manifestPath) {
  ...
  final m = RegExp(r'(<application\b)([^>]*?)(/?>)', dotAll: true).firstMatch(xml);
...
List<AppliedFix> _fixLiveActivityPlist(MosaicConfig config, String projectRoot) {
...
String _entitlementsPlist(String group) => '''<?xml version="1.0" encoding="UTF-8"?>
