...
void main() {
  ...
  const duplicatePairs = <String, List<Map<String, dynamic>>>{
    'text': [
      {'__type': 'HWText', 'text': {'__type': 'HWBind', 'key': 'k'}},
      {'__type': 'HWText', 'text': {'__type': 'HWBind', 'key': 'k'}},
    ],
    'progress': [
      {'__type': 'HWProgressBar', 'value': {'__type': 'HWBind', 'key': 'k'}, 'max': 100},
      {'__type': 'HWProgressBar', 'value': {'__type': 'HWBind', 'key': 'k'}, 'max': 100},
    ],
    'gauge': [
      {'__type': 'HWGauge', 'value': {'__type': 'HWBind', 'key': 'k'}, 'max': 100},
      {'__type': 'HWGauge', 'value': {'__type': 'HWBind', 'key': 'k'}, 'max': 100},
    ],
    'networkImage': [
      {'__type': 'HWNetworkImage', 'url': {'__type': 'HWBind', 'key': 'k'}},
      {'__type': 'HWNetworkImage', 'url': {'__type': 'HWBind', 'key': 'k'}},
    ],
    'sparkline': [
      {'__type': 'HWSparkline', 'bind': {'__type': 'HWBind', 'key': 'k'}},
      {'__type': 'HWSparkline', 'bind': {'__type': 'HWBind', 'key': 'k'}},
    ],
    'barChart': [
      {'__type': 'HWBarChart', 'bind': {'__type': 'HWBind', 'key': 'k'}},
      {'__type': 'HWBarChart', 'bind': {'__type': 'HWBind', 'key': 'k'}},
    ],
    'semantics': [
      {'__type': 'HWSemantics', 'label': {'__type': 'HWBind', 'key': 'k'}, 'child': {'__type': 'HWText', 'text': 'a'}},
      {'__type': 'HWSemantics', 'label': {'__type': 'HWBind', 'key': 'k'}, 'child': {'__type': 'HWText', 'text': 'b'}},
    ],
    'visibility': [
      {'__type': 'HWVisibility', 'bind': {'__type': 'HWBind', 'key': 'k'}, 'child': {'__type': 'HWText', 'text': 'a'}, 'replacement': {'__type': 'HWText', 'text': 'b'}},
      {'__type': 'HWVisibility', 'bind': {'__type': 'HWBind', 'key': 'k'}, 'child': {'__type': 'HWText', 'text': 'c'}, 'replacement': {'__type': 'HWText', 'text': 'd'}},
    ],
  };
