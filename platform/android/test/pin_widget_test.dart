...
void main() {
  ...
  test('every widget is mapped to its generated provider class', () async {
    ...
    expect(kt, contains('"News" to com.acme.app.mosaic_generated.NewsProvider::class.java'));
    expect(kt,
        contains('"Weather" to com.acme.app.mosaic_generated.WeatherProvider::class.java'));
  });
