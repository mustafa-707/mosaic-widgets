...
Group {
    if #available(iOS 16.0, *) {
        Text(timerInterval: Date(timeIntervalSince1970: 1780387870.62)...Date.distantFuture, countsDown: false)
    } else {
        Text(Date(timeIntervalSince1970: 1780387870.62), style: .timer)
    }
