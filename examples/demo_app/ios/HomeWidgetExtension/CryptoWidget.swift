...
Text(Date(timeIntervalSince1970: 1780236787.342), style: .timer).foregroundColor(Color(red: 1.0, green: 1.0, blue: 1.0, opacity: 1.0)).font(.system(size: 8.0)).monospacedDigit()
}
}
