...
Group {
    if #available(iOS 16.0, *) {
        Text(timerInterval: Date(timeIntervalSince1970: 1780382767.131)...Date.distantFuture, countsDown: false)
    } else {
        Text(Date(timeIntervalSince1970: 1780382767.131), style: .timer)
    }
