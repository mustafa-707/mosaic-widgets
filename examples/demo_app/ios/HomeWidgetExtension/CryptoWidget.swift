...
Group {
    if #available(iOS 16.0, *) {
        Text(timerInterval: Date(timeIntervalSince1970: 1785657504.68)...Date.distantFuture, countsDown: false)
    } else {
        Text(Date(timeIntervalSince1970: 1785657504.68), style: .timer)
    }
