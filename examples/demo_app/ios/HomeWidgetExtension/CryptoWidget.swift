...
Group {
    if #available(iOS 16.0, *) {
        Text(timerInterval: Date(timeIntervalSince1970: 1785835566.623)...Date.distantFuture, countsDown: false)
    } else {
        Text(Date(timeIntervalSince1970: 1785835566.623), style: .timer)
    }
