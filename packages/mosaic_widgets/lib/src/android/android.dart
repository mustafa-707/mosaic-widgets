...
class AndroidGenerator {
  ...
  String registerSystemColor(
    ...
    final name =
        'mosaic_sys_${_colorHash('$sysLight|$fallbackLight|$fallbackDark')}';
    _systemColors[name] = (
      sysLight: sysLight,
      sysDark: sysDark,
  ...
  /// ImageView.
  final List<
          ({String viewId, String key, String color, double stroke, bool fill})>
      _sparklines = [];
  ...
  void registerSparkline(String viewId, String key,
    ...
    _sparklines.add(
        (viewId: viewId, key: key, color: color, stroke: stroke, fill: fill));
  }
...
$body
  ...
  static const Map<String, ({String light, String dark})> _systemColorNames = {
    ...
    'onSurfaceMuted': (
      light: 'system_neutral2_700',
      dark: 'system_neutral2_200'
    ),
  };
  ...
  String parseColor(Map<String, dynamic> colorData) {
    ...
    if (system != null) {
      ...
      if (entry != null) {
        return registerSystemColor(entry.light, entry.dark, light, darkValue);
      }
