...
void main() {
  group('iOS 18 Control Widget generation', () {
    test('toggle control emits <Name>Control.swift with ControlWidgetToggle',
      ...
      final swift =
          readFile(res.file('ios/HomeWidgetExtension/TorchControl.swift'));
      ...
      expect(swift,
          contains('Label("Flashlight", systemImage: "flashlight.on.fill")'));
    });
    ...
    test('button control emits <Name>Control.swift with ControlWidgetButton',
      ...
      expect(
          swift, contains('MosaicCallbackIntent(callbackName: "ping_server")'));
      expect(
          swift,
          contains(
