...
void main() {
  test(
      'Column with crossAxisAlignment stretch generates and contains stretch comment',
      () async {
  ...
  test(
      'Row with crossAxisAlignment stretch generates and contains stretch comment',
      () async {
    final r = await runIos([
      irDef({
        '__type': 'HWRow',
